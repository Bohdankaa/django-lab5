    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('TEA', 'Чай'), ('COFFEE', 'Кава'), ('ACCESSORY', 'Аксесуар'), ('OTHER', 'Інше')], default='OTHER', max_length=20, verbose_name='Тип товару')),
                ('added_date', models.DateTimeField(auto_now_add=True, verbose_name='Дата додавання')),
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='products', to='TeaCoffe.category', verbose_name='Категорія')),
            ],
            options={
